...
export default function AreaItemCarrinho(props: AreaItemCarrinhoProps) {
    return (
        <div className="flex items-center gap-5 bg-zinc-700 rounded-md overflow-hidden">
            ...
            <div className="flex gap-2 items-center px-5">
                ...
                <span className="flex px-4 py-2 rounded-md bg-zinc-800">{props.item.quantidade}</span>
